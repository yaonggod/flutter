...
class PostOrderBody {
  ...
  PostOrderBody({ required this.id, required this.products, required this.totalPrice, required this.createdAt });
...
class PostOrderBodyProduct {
  ...
  PostOrderBodyProduct({ required this.productId, required this.count });
